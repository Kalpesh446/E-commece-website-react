...
export const paginationItems = [
  ...
  },
  {
    ...
    ficheTech: [
      ...
      { label: "Impression recto-verso automatique      ", value: "Oui" },
      {
        ...
        value: "Impression brochure, impression sécurisée, impression disque USB Compatible AirPrint, Mopria, APP mobile (APP iOS/App Android)",
      },
...

  {
    ...
    ficheTech: [
      ...
      { label: "Type ecran		", value: "LCD 2 lignes      " },
      {
        ...
        value: "Impression : 525 W en moyenne Veille : 50 W en veille : moins de 2 W      ",
      },
      {
...

  {
    ...
    ficheTech: [
      ...
      },
      {
        ...
        value: "Ethernet USB 2.0 haut débit : Wi-Fi IEEE 802.3 10/100Base-Tx : IEEE 802.11b/g/n      ",
      },
      {
        label: "Contenu de L'emballage		",
        value: "Imprimante - Cordon d’alimentation - Câble d’interface USB - Plateau de sortie - CD-ROM - Guide de configuration rapide      ",
      },
...

  {
    _id: "hp1",
    img: hp1,
    productName: "IMPRIMANTE HP JET D'ENCRE HP SMART TANK 516 COULEUR MFP 3EN1 A4 WIFI",
    price: "450",
    color: "Blanc",
    badge: true,
    brand: "Hp",
...

  {
    ...
    ficheTech: [
      ...
      {
        label: "Contenu de L'emballage",
        value: "HP Ink Tank 315 , cartouche d'encre noire HP GT51 (90CC), cartouche d'encre cyan HP GT52 (70CC), cartouche d'encre magenta HP GT52 (70CC), cartouche d'encre jaune HP GT52 (70CC)",
      },
